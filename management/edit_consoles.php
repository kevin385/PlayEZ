...
if (isset($_POST['submitted'])) {
	...
	if (empty($errors)) { // If everything's OK.
				//Update
	 			// Make the query.
			$query = "UPDATE console SET drive_type='$drive_type',  details = '$details', size = $size WHERE console_id = $id";
...
$query = "SELECT console_id, drive_type,details,size FROM console  WHERE console_id = $id";
$result = @mysqli_query ($dbc, $query); // Run the query.
//var_dump($result);

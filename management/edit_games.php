...
$query = "SELECT Games_id, games_name,min_memory_size, max_no_players, games.details,console_fk, drive_type  FROM games, console WHERE games.Games_id = $id  AND console.console_id = games.console_fk ";
$result = @mysqli_query ($dbc, $query); // Run the query.

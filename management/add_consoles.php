...
if (isset($_POST['submitted'])) {
	...
	if (empty($errors)) { // If everything's okay.
		...
		// Make the query.
		$query = "INSERT INTO console (console_id, drive_type, size, details) VALUES ($console_id,'$drive_type', $size, '$details')";		
...
// customer drop-down
//SELECT Product_id FROM Product WHERE description ='console' AND Product_id  NOT IN (select console_id FROM console) 
$query_sub = "SELECT * FROM Product where description = 'console' AND Product_id  NOT IN (select console_id FROM console)";
